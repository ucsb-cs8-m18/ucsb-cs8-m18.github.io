...
ready: true
desc: "Midterm Exam"
exam_date: 2018-08-23 09:30:00.00-7
---
...
* Python objects and classes, and the use of class constructors to create new objects (e.g., `int(2), turtle.Turtle()`)
...
* Modules, `import`ing, and accessing the things defined in them
